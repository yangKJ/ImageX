...
options.Network.cacheOption = .disk // 采用磁盘缓存
options.Network.cacheCrypto = .user { "Condy" + CryptoType.SHA.sha1(string: $0) } // 自定义加密
options.Network.cacheDataZip = .gzip // 采用GZip方式压缩数据
